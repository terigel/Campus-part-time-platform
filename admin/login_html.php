        ...
        <div class="box">
        	<form method="post" action="login_cl.php" onsubmit="return login_check()">
        		<div >
                    ...
                    <div class="yz">
						<input placeholder="请输入验证码" type="text" name="user_yz" class="in3"><a href="#" id="change"><img id="code_img" src="code.php" style="display:inline-block;vertical-align:middle;"></a>
					</div>
                    <div>
